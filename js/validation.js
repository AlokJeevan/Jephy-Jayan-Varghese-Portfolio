$("#submit-form").submit((e)=>{
    e.preventDefault()
    $.ajax({
        url:"https://script.google.com/macros/s/AKfycbyvsEMr8_o8uNRSyh-kdjxaHG55xuz615sedJwzf0hJsztlIGsXisL4kJe_Br2XIadXCA/exec",
...
function validateName(){
  ...
  if(!nameField.match(/^[A-Za-z0-9]*\s{1}[A-Za-z]+$/) ){
